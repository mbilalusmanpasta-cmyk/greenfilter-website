  ...
  return (
    <>
      <GuaranteeElement2Wrapper>
        <div className="container-5 w-container">
          <div className="titles-div less-padding">
            ...
            <Grid container style={{ margin: "15px 0 15px 0" }}>
              ...
              <Grid item xs={12} sm={12} md={6}>
                <Button1 text="Warranty Card" to="/documents/gfu_warranty_card.pdf" target="_blank" />
              </Grid>
            </Grid>
        ...
        <Button1 text="Filter Return Form" marginTop={20} to="/documents/gfu_filter_credit_return.pdf" target="_blank" /> 
      </GuaranteeElement2Wrapper>
    </>
  );
};
